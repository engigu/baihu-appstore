...
setup:
  ...
  # [可选] 应用卸载清理
  uninstall: mise exec {mise_languages} -- node -e "['bin','main/RayWangQvQ_BiliBiliToolPro/src/Ray.BiliBiliTool.Console/obj'].forEach(p => require('fs').rmSync('{{app_dir}}/'+p, {{recursive: true, force: true}}))"
